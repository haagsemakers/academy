...
export const courses = [
  {
    code: 'hm-001',
    title: 'Arduino Basis',
    subtitle: 'Leer in 4 dagdelen de basisvaardigheden voor het werken met Arduino.',
    featured_img: 'nicolas-thomas-533958.jpg',
    slug: 'arduino-basis',
    ...
    objectives: [
      ...
      { title: 'Basiskennis programmeren: Functies en loops' },
      { title: '4 werkende prototypes ' }
    ],
    sessions: [
      {
        title: 'Introduction',
        description: 'This is an introduction course'
      },
      {
        title: 'Go with the flow',
        description: 'This is go with the flow'
      }
    ],
    teachers: [
      {
        name: 'Max Vijftigschil'
      },
      {
  ...
  {
    code: 'hm-002',
    title: 'The Things Network Connect Basis (IoT)',
    subtitle: 'Leer in 4 dagdelen de basisvaardigheden voor het werken met Arduino.',
    featured_img: 'bench-accounting-49025.jpg',
